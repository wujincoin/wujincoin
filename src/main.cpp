...
#if defined(NDEBUG)
# error "WuJinCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "WuJinCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
        nSubsidy = 98888888 * COIN;	// 1 billion coins, that all pow coins
...
{
    RenameThread("WuJinCoin-loadblk");
